        ...
        <div id="app" class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 ">
                <div class="pt-8 pb-3 d-flex justify-content-center">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="400.29" height="75.9" viewBox="0 0 1213 230">
                ...
                <div class="card" style="width: 30rem;">
                    <div class="card-header">{{ __('strings.lb_password_reset') }}</div>

                    <div class="card-body">
                        <form method="POST" action="/passwdResetDo">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="usname" type="text" class="form-control @error('usname') is-invalid @enderror" name="usname" value="{{ old('usname') }}" required autocomplete="usname" autofocus>
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 mt-4 col-form-label text-md-right"></label>
                                <div class="col-md-6 mt-2">
                                    <small class="text-primary">{{ __('strings.str_new_password_send') }}</small>
                                </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fa fa-check-circle"></i> {{ __('strings.fn_submit') }}
                                    </button>
                                </div>
                            </div>
                        </form>
