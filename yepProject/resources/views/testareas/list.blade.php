        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="taFrm" id="taFrm" method="post" action="/addTestArea">
                    ...
                    <div class="form-group">
                        ...
                        <select name="info_parent_id" id="info_parent_id" class="form-control">
                            ...
                            @foreach ($parents as $parent)
                                <option value="{{ $parent->id }}" data-sub="{{ $parent->ta_code }}">{{ $parent->ta_name }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="info_max_score">{{ __('strings.lb_max_score') }}</label>
                        <input type="text" name="info_max_score" id="info_max_score" class="form-control" value="{{ $maxScore }}" placeholder="{{ __('strings.str_insert_max_score') }}"/>
                    </div>
                </form>
            </div>
