...
&lt;!&ndash;                                <input type="checkbox" name="ss_id[]" id="ss_id_{{ $data[$i]["id"] }}" value="{{ $data[$i]["id"] }}" class="form-check-input" checked/>&ndash;&gt;
                        ...
                        @foreach ($tItems as $item)
                            @if ($item->sj_has_child == "N")
                                ...
                                <td class="form-group d-flex justify-content-center">
                                        <input type="text"
                        ...
                        <td>
                            @if ($data[$i]["sent"] == "N")
                                <div class="btn-group-sm btn-group">
                                    <a href="#" class="btn btn-primary btn-sm fn_item text-nowrap" fn_id="{{ $data[$i]["id"] }}" fn_item_row="{{ $i }}" title="{{ __('strings.fn_save') }}">
                                        <span class="fa fa-spin fa-spinner fn_fa_{{ $i }} d-none"></span> <i class="fa fa-save"></i></a>
                                </div>
                            @else
