...
<div class="container-fluid">
    ...
    <div class="mt-3">
        ...
        <a href="/options" class="btn btn-outline-primary btn-sm"><i class="fa fa-filter"></i> {{ __("strings.lb_options_manage") }}</a>
    </div>
    @if ($errors->any())
        ...
        <table class="mt-3 table table-striped">
            <thead>
                <tr class="text-center">
                    ...
                    <th scope="col">{{ __('strings.lb_old_value') }}</th>
                    <th scope="col">{{ __('strings.lb_new_value') }}</th>
            ...
            @foreach($data as $datum)
                <tr class="text-center">
                    ...
                    <td>{{ $datum->opt_code }}</td>
                    <td>{{ $datum->opt_old_value }}</td>
                    <td>{{ $datum->opt_new_value }}</td>
                    <td>{{ $datum->opt_log_desc }}</td>
                </tr>
            @endforeach
            </tbody>
        </table>
